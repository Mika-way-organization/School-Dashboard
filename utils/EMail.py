...
"""
    ...
    @staticmethod
    def new_verify_code_email(email_adress, code):
        msg = Message(
            subject="Neuer Verifizierungs Code",
            recipients=[email_adress],
            html=f"""
        <!DOCTYPE html>
        <html lang="de">
        <head>
            <meta charset="UTF-8">
            <meta name="viewport" content="width=device-width, initial-scale=1.0">
            <title>Neuer Verifizierungscode</title>
        </head>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #f8f9fa; /* Bootstrap Light Text */ margin: 0; padding: 0; background-color: #212529;">
            ...
            <div style="max-width: 600px; margin: 20px auto; padding: 25px; 
                ...
                <p style="font-size: 16px; color: #f8f9fa;">
                    Willkommen zurück auf der Schul-Dashboard Website. Hier ist Ihr neuer Verifizierungscode.
                </p>
                <p style="font-size: 16px; color: #f8f9fa;">
                    Sie haben einen neuen Verifizierungcode für Ihre E-Mail-Adresse angefordert. Bitte verwenden Sie diesen Code:
                </p>
                ...
                <p style="font-size: 16px; color: #ffc107; /* Bootstrap Warning Yellow */ font-weight: bold;">
                    Dieser Code ist auch nur <b>10 Minuten</b> lang gültig.
                </p>
